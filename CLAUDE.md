...
- **운영 `R_CH1/CH2.npz` 는 2026-07-10 산물이라 5/29 시계 보정(`f897ce8`,
  2026-09-19)보다 앞선다.** 2026-05-18~05-29 구간의 R knot 이 **보정 전 raw
  시각**에 있어서, 보정된 알파와 **9 h 어긋난 채** 보간된다 — 그 구간 알파는
  9시간 묵은 R 로 만들어졌다. R npz 를 재생성하기 전까지 그 창의 R 관련 수치를
