...
_RESULT_FIELDS = {"schema", "candidate_id", "status", "policy", "budget",
    ...
    "limitations", "sampling", "source", "quality_gate", "t2_gate", "t2_diagnostics", "retrieval_integrity",
...
_PUBLIC_KEYS = _RESULT_FIELDS | {
    ...
    "final_shift", "final_squeeze", "fit_executed", "fit_role", "fitset", "gas_order",
    ...
    "time_source", "timestamp", "target_concentration", "upper", "value", "wavecal", "rms", "rms_sig", "T_C", "P_mbar", "temperature_pressure_source", "t2_gate", "t2_diagnostics", "retrieval_integrity", "state", "reason", "details", "anchors", "abs_ratio", "limit", "target_multiple_R", "threshold", "incomplete", "n", "outlier_count", "median", "mad_scaled", "successful_attempts", "coefficient_health", "collinearity", "absolute_anchor", "checks", "attempt_completeness", "expected_attempts", "executed_attempts", "temperature_pressure", "applicability"}
...
def _validate_public_value(value, key=""):
    ...
    if isinstance(value, dict):
        if key in {"t2_gate", "t2_diagnostics", "retrieval_integrity", "reference_roles", "reference_observability"}:
