...
실제 구현은 아래 세 서브모듈에 분산되어 있다:
  ...
  ui_dialogs_r.py      — R_GeneratorDialog, _RTrendWorker, RTrendMonitorDialog
...
from .ui_dialogs_r     import *   # R_GeneratorDialog, RTrendMonitorDialog
from .ui_dialogs_r     import _RTrendWorker  # private class — explicit import needed
